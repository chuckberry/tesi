In this chapter, we will try to understand why current version of task-affinity is not effective on Intel Xeon, and which are the points of task-affinity 
